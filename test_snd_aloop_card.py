...
# Title: Test loopback sound card
# Author: ubuntu
...
class test_snd_aloop_card(gr.top_block, Qt.QWidget):

    def __init__(self, audio_in='plughw:0,1,0', audio_out='plughw:0,0,0'):
        gr.top_block.__init__(self, "Test loopback sound card", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Test loopback sound card")
        ...
        self.settings = Qt.QSettings("GNU Radio", "test_snd_aloop_card")
        ...
        self._fc_range = qtgui.Range(100, 20000, 1, 1000, 200)
        ...
        self.audio_source_0 = audio.source(samp_rate, audio_in, True)
...
def argument_parser():
    ...
    parser.add_argument(
        "--audio-in", dest="audio_in", type=str, default='plughw:0,1,0',
        help="Set Audio Input [default=%(default)r]")
    parser.add_argument(
        "--audio-out", dest="audio_out", type=str, default='plughw:0,0,0',
        help="Set Audio Out [default=%(default)r]")
    return parser


def main(top_block_cls=test_snd_aloop_card, options=None):
    if options is None:
