...
class untitled(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.digital_pfb_clock_sync_xxx_0 = digital.pfb_clock_sync_ccf(sps, (2*3.14/100), variable_rrc_filter_taps_0, 16, 0, 1.5, 2)
        ...
        self.connect((self.blocks_char_to_float_1, 0), (self.digital_correlate_access_code_xx_ts_0, 0))
        ...
        self.connect((self.digital_correlate_access_code_xx_ts_0, 0), (self.qtgui_time_sink_x_0, 0))
