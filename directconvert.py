...
# Title: Direct converter
# Description: Convert I/Q signals to qam modulated signal and vice versa.
...
class directconvert(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Direct converter", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Direct converter")
        ...
        self.settings = Qt.QSettings("GNU Radio", "directconvert")
        ...
        self.analog_sig_source_x_2_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, fc, 1, 0, 0)
        self.analog_sig_source_x_2 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, fc, 1, 0, 0)
        ...
        self.connect((self.analog_sig_source_x_1, 0), (self.qtgui_freq_sink_x_1, 1))
        self.connect((self.analog_sig_source_x_2, 0), (self.blocks_complex_to_float_0, 0))
        self.connect((self.analog_sig_source_x_2_0, 0), (self.blocks_complex_to_float_0_0, 0))
        ...
        self.connect((self.blocks_complex_to_float_0_0, 1), (self.blocks_multiply_xx_0_1_0, 0))
        ...
        self.connect((self.blocks_sub_xx_0, 0), (self.blocks_multiply_xx_0_1, 0))
        self.connect((self.blocks_sub_xx_0, 0), (self.blocks_multiply_xx_0_1_0, 1))
        self.connect((self.blocks_sub_xx_0, 0), (self.qtgui_freq_sink_x_2, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 1e3, 500, window.WIN_HAMMING, 6.76))
        self.low_pass_filter_0_0.set_taps(firdes.low_pass(1, self.samp_rate, 2e3, 500, window.WIN_HAMMING, 6.76))
    ...
    def set_fc(self, fc):
        ...
        self.analog_sig_source_x_2_0.set_frequency(self.fc)




def main(top_block_cls=directconvert, options=None):
