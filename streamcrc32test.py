...
class streamcrc32test(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Test StreamCrC32", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Test StreamCrC32")
        ...
        self.settings = Qt.QSettings("GNU Radio", "streamcrc32test")
        ...
        self.connect((self.digital_crc32_bb_0, 0), (self.digital_crc32_bb_1, 0))
...
def main(top_block_cls=streamcrc32test, options=None):
