...
class bfsk_transceive(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, dest_host='127.0.0.1', dest_port='42028', deviation=600, in_file='in.bin', num_pream_packets=4, packet_size=16, passband_fc=2800, samp_rate=48000, sps=375, wav_out='out.wav'):
...
def argument_parser():
    ...
    parser.add_argument(
        "--sps", dest="sps", type=intx, default=375,
